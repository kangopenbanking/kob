...
class KOBClient {
  constructor(baseURL) {
    this.baseURL = baseURL || 'https://api.kangopenbanking.com';
...
const KOB_API = 'https://api.kangopenbanking.com';
...
KOB_API = 'https://api.kangopenbanking.com'
...
class KOBService
{
    private $apiBase = 'https://api.kangopenbanking.com';
    private $clientId;
