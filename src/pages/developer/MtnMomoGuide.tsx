...
const mtnCharge = `curl -X POST https://api.kangopenbanking.com/v1/gateway/charges \\
...
6. Webhook fires: charge.captured (or charge.failed)
  ...
  "meta": { "request_id": "req_abc123", "api_version": "4.6.0" }
        ...
        <section>
          ...
          <CodeBlock examples={[{ code: `curl -X POST https://api.kangopenbanking.com/v1/gateway/payouts \\
  -H "Authorization: Bearer sk_test_sandbox_KangOB2026Demo" \\
  -H "Idempotency-Key: $(uuidgen)" \\
  -d '{
    "amount": "10000",
