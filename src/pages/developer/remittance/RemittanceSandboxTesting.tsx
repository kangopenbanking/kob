...
export default function RemittanceSandboxTesting() {
    ...
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <div className="space-y-4">
        ...
        <CodeBlock
          ...
          examples={[{
            language: "bash",
            code: `curl "https://api.kangopenbanking.com/functions/v1/remittance-engine?action=list_corridors&to_country=CM" \\
  -H "Authorization: Bearer SANDBOX_TOKEN"`
        ...
        <CodeBlock
          ...
          examples={[{
            language: "bash",
            code: `curl -X POST https://api.kangopenbanking.com/functions/v1/remittance-engine \\
  -H "Authorization: Bearer SANDBOX_TOKEN" \\
  ...
  -d '{"action":"create_quote","from_country":"FR","to_country":"CM","send_amount":50,"send_currency":"EUR","receive_currency":"XAF"}'`
        ...
        <CodeBlock
          ...
          examples={[{
            language: "bash",
            code: `curl -X POST https://api.kangopenbanking.com/functions/v1/remittance-outbound \\
  -H "Authorization: Bearer SANDBOX_TOKEN" \\
  ...
  -d '{"action":"send","quote_id":"qt_xxx","recipient_name":"Test User","recipient_phone":"+237670000001","payout_method":"momo_mtn"}'`
        ...
        <CodeBlock
          ...
          examples={[{
            language: "bash",
            code: `curl -X POST https://api.kangopenbanking.com/functions/v1/remittance-payin-intent \\
  -H "Authorization: Bearer SANDBOX_TOKEN" \\
  -H "Content-Type: application/json" \\
  -d '{"action":"create_stripe_intent","remittance_id":"rem_xxx"}'`
        ...
        <CodeBlock
          ...
          examples={[{
            language: "bash",
            code: `curl "https://api.kangopenbanking.com/functions/v1/remittance-outbound?action=track&remittance_id=rem_xxx" \\
  -H "Authorization: Bearer SANDBOX_TOKEN"`
          }]}
        />
      </div>
      ...
      <div className="space-y-4">
        ...
        <CodeBlock
          ...
          examples={[{
            language: "bash",
            code: `curl -X POST https://api.kangopenbanking.com/functions/v1/remittance-client-webhooks \\
  -H "Content-Type: application/json" \\
  -d '{
    "action": "register",
