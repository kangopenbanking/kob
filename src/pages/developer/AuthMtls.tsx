  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Mutual TLS (mTLS) authentication for institutional clients. Certificate registration, renewal, and certificate-bound token usage." />
      ...
      <div className="max-w-4xl space-y-10">
        <div>
          ...
          <p className="text-lg text-muted-foreground">
            Mutual TLS (mTLS) provides the highest level of authentication security by binding access tokens to a specific client certificate. Required for regulated financial institutions under FAPI 1.0 Advanced.
          </p>
        </div>

        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4" id="overview">How mTLS Works</h2>
...
└──────────┘                    └──────────────┘`}
          ...
          <p className="text-muted-foreground">
            When using mTLS, the access token contains a <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">cnf</code> (confirmation) claim with the certificate thumbprint. The server validates that the certificate used for TLS matches the one bound to the token.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4" id="lifecycle">Certificate Lifecycle</h2>
