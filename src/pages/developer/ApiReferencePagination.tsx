...
curl https://wdzkzeahdtxlynetndqw.supabase.co/functions/v1/gateway/charges?limit=20 \\
  -H "Authorization: Bearer sk_test_sandbox_KangOB2026Demo"

# Next page using cursor
curl "https://wdzkzeahdtxlynetndqw.supabase.co/functions/v1/gateway/charges?limit=20&cursor=eyJpZCI6IjEyMyJ9" \\
  -H "Authorization: Bearer sk_test_sandbox_KangOB2026Demo"`;
