...
const parseCamt052 = `curl -X POST https://sandbox.kangopenbanking.com/v1/standards/iso20022/camt052/parse \\
...
const generatePacs008 = `curl -X POST https://sandbox.kangopenbanking.com/v1/standards/iso20022/pacs008/generate \\
  -H "Authorization: Bearer sk_test_sandbox_KangOB2026Demo" \\
