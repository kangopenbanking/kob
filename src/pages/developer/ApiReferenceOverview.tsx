...
const errorResponse = `{
  "type": "https://api.kangopenbanking.com/errors/insufficient-funds",
  "title": "Insufficient Funds",
  "status": 422,
  "detail": "The account balance of 2,000 XAF is insufficient for the 5,000 XAF charge.",
  "instance": "https://api.kangopenbanking.com/errors/log/err_a1b2c3d4",
            ...
            <table className="w-full text-sm border border-border rounded-lg">
              ...
              <tbody>
                ...
                <tr className="border-t border-border">
                  ...
                  <td className="p-3 font-mono text-sm text-muted-foreground">https://sandbox.kangopenbanking.com/v1</td>
                </tr>
              </tbody>
            </table>
          </div>
