...
export default function Playground() {
  ...
  const generateCurlCommand = () => {
    ...
    if (endpoint.method === "GET") {
      return `curl -X GET "https://api.kangopenbanking.com/functions/v1/${selectedEndpoint}" \\
  -H "Content-Type: application/json"`;
    } else {
      return `curl -X POST "https://api.kangopenbanking.com/functions/v1/${selectedEndpoint}" \\
  -H "Content-Type: application/json" \\
  -d '${requestBody}'`;
    }
  };
