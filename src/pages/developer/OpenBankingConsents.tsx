...
const createConsent = `curl -X POST https://sandbox.kangopenbanking.com/v1/aisp/consents \\
...
const revokeConsent = `curl -X DELETE https://sandbox.kangopenbanking.com/v1/aisp/consents/cns_abc123def456 \\
  -H "Authorization: Bearer sk_test_sandbox_KangOB2026Demo"`;
