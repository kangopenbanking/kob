          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-muted p-3 rounded-lg flex items-center justify-between">
                  <code className="text-sm">https://api.kangopenbanking.com/functions/v1/postman-collection</code>
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => window.open('https://api.kangopenbanking.com/functions/v1/postman-collection', '_blank')}
                  >
                    <ExternalLink className="h-4 w-4 mr-2" />
                    View
                  </Button>
...
class KangOpenBanking {
  private baseUrl = 'https://api.kangopenbanking.com';
