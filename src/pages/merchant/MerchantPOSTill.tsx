...
const MerchantPOSTill: React.FC = () => {
  // Resolve merchantId from user's merchant record
  ...
  const {
    ...
    globalDiscount, setGlobalDiscount, discountType, setDiscountType,
        ...
        {cart.length > 0 && (
          <div className="border-t p-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <Button
                className="flex-col gap-1 h-auto py-3 bg-emerald-600 hover:bg-emerald-700 text-white"
              ...
              <Button
                className="flex-col gap-1 h-auto py-3 bg-primary hover:bg-primary/90"
              ...
              <Button
                className="flex-col gap-1 h-auto py-3 bg-orange-600 hover:bg-orange-700 text-white"
