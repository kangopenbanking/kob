  ...
  return (
    <div className="flex flex-col gap-6 p-5">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-4 py-20">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[hsl(180,50%,90%)]">
          <Link2 className="h-8 w-8 text-foreground" strokeWidth={1.5} />
        </div>
        <p className="text-sm text-muted-foreground">Pay Links feature coming soon</p>
      </div>
    </div>
  );
};
