...
const CustomerTravelTrips: React.FC = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: theme.lightBg }}>
      {/* ── Themed Header ── */}
      <div className="relative overflow-hidden px-5 pb-10 pt-4" style={{ backgroundColor: theme.color }}>
            ...
            <div className="px-5">
              ...
              {filteredTrips.length === 0 ? (
                <div className="flex flex-col items-center gap-3 rounded-2xl bg-white py-14 text-center shadow-sm">
                  ...
                  <p className="font-bold text-[#0f1729]">No upcoming trips</p>
                  <p className="text-[12px] text-[#0f1729]/40 max-w-[200px]">Check back later for new schedules</p>
                </div>
              ) : (
