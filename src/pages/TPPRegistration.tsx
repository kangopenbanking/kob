          ...
          <CardContent className="space-y-2">
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-sm text-muted-foreground font-mono">
                <li>• JWKS: {import.meta.env.VITE_SUPABASE_URL}/functions/v1/jwks-endpoint</li>
                <li>• OIDC Config: {import.meta.env.VITE_SUPABASE_URL}/functions/v1/oidc-config</li>
                <li>• PAR: {import.meta.env.VITE_SUPABASE_URL}/functions/v1/par-endpoint</li>
                <li>• DCR: {import.meta.env.VITE_SUPABASE_URL}/functions/v1/dcr-register</li>
              </ul>
            </div>
          </CardContent>
        </Card>
