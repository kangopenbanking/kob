                ...
                <div className="rounded-2xl border border-border/40 bg-card overflow-hidden transition-all hover:border-border/80 hover:shadow-sm">
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-sm font-bold text-foreground mt-2">
                      {new Intl.NumberFormat('fr-CM').format(product.pos_product_variants?.[0]?.price || 0)} <span className="text-[10px] font-medium text-muted-foreground">FCFA</span>
                    </p>
                    ...
                    <div className="flex gap-1.5 mt-3">
                      ...
                      <Button
                        size="sm"
                        variant="ghost"
                        className="rounded-xl h-8 w-8 p-0 text-rose-500 hover:bg-rose-500/10 hover:text-rose-600"
