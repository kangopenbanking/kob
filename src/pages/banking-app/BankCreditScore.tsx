...
import { ArrowLeft, BarChart3, TrendingUp, Shield, Clock } from 'lucide-react';
...
const BankCreditScore: React.FC = () => {
  ...
  const factors = [
    { icon: TrendingUp, label: 'Payment History', value: 'Excellent', color: 'bg-[hsl(var(--bank-mint))]', fg: 'text-[hsl(var(--bank-mint-fg))]' },
    { icon: BarChart3, label: 'Credit Utilization', value: '23%', color: 'bg-[hsl(var(--bank-amber))]', fg: 'text-[hsl(var(--bank-amber-fg))]' },
    { icon: Shield, label: 'Account Age', value: '2 years', color: 'bg-[hsl(var(--bank-sky))]', fg: 'text-white' },
    { icon: Clock, label: 'Recent Inquiries', value: '1', color: 'bg-[hsl(var(--bank-violet))]', fg: 'text-white' },
  ];
