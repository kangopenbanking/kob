          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-semibold mb-4">
                <span className="h-2 w-2 rounded-full bg-primary" /> Card Issuing
              </div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">
                Issue virtual, digital and physical cards through one API
              </h2>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Issue cards globally through Kang Open Banking. Push-provision to Apple Pay and Google Pay,
                ship physical cards worldwide, and stay PCI-DSS compliant — card data never touches your servers.
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-3xl bg-primary p-8 aspect-[1.586] shadow-2xl overflow-hidden">
                <div className="absolute right-8 top-8 h-24 w-24 rounded-full border border-primary-foreground/10" />
                <div className="absolute right-14 top-14 h-16 w-16 rounded-full border border-primary-foreground/10" />
                <div className="flex items-start justify-between">
                  <div className="text-primary-foreground/80 text-xs font-semibold tracking-widest">KANG OPEN BANKING</div>
                  <div className="text-primary-foreground/60 text-[10px] uppercase tracking-widest">Virtual</div>
                </div>
                <div className="mt-16 text-primary-foreground font-mono tracking-[0.3em] text-lg">•••• •••• •••• 4291</div>
                <div className="mt-4 flex justify-between text-primary-foreground">
                  <div>
              ...
              <div className="absolute -bottom-4 -right-4 rounded-2xl bg-card border border-border shadow-lg px-4 py-3 text-xs">
                ...
                <div className="text-muted-foreground">Multi-issuer routing</div>
              </div>
            </div>
          </div>
        </div>
