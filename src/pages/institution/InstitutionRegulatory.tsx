    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-border bg-muted"><FileText className="h-5 w-5 text-muted-foreground" /></div>
          <div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {[
          ...
          { label: "Acknowledged", value: acknowledged, icon: CheckCircle },
        ].map(s => (
