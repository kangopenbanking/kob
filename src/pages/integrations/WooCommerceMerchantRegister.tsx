    ...
    return (
      <div className="min-h-screen bg-background relative overflow-hidden">
        ...
        <div className="container relative z-10 max-w-4xl mx-auto py-16 px-4">
          ...
          >
            <Card className="border-2 border-green-200 bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl overflow-hidden">
              ...
              <CardContent className="p-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <Label className="flex items-center gap-2 text-base font-semibold">
                      <Key className="h-5 w-5 text-[#96588a]" />
                      API Key
                    </Label>
                    <div className="flex gap-2">
                      <Input 
                        ...
                        readOnly 
                        className="font-mono text-sm bg-white border-2 focus:border-[#96588a] rounded-xl"
                      />
                      <Button
                        variant="outline"
                        size="icon"
                        onClick={() => handleCopy(credentials.api_key, "API Key")}
                        className="rounded-xl border-2 hover:bg-[#96588a]/5 hover:border-[#96588a] transition-all duration-200"
                      >
                        {copiedField === "API Key" ? (
                          <Check className="h-4 w-4 text-green-600" />
                        ) : (
                          <Copy className="h-4 w-4 text-[#96588a]" />
                        )}
                      </Button>
                    </div>
                  </motion.div>
                  ...
                  >
                    <Label className="flex items-center gap-2 text-base font-semibold">
                      <Lock className="h-5 w-5 text-[#96588a]" />
                      Client Secret
                    </Label>
                    <div className="flex gap-2">
                      <Input 
                  ...
                  >
                    <Label className="flex items-center gap-2 text-base font-semibold">
                      <Webhook className="h-5 w-5 text-[#96588a]" />
                      Webhook Secret
                    </Label>
                    <div className="flex gap-2">
                      <Input 
                  ...
                  >
                    <Label className="flex items-center gap-2 text-base font-semibold">
                      <Globe className="h-5 w-5 text-[#96588a]" />
                      Webhook URL
                    </Label>
                    <div className="flex gap-2">
                      <Input 
                ...
                >
                  ...
                  <div className="space-y-3 text-sm text-muted-foreground">
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#96588a] text-white flex items-center justify-center flex-shrink-0 text-xs font-bold">1</div>
                      <p>Install the Woo for Kang plugin in your WordPress admin</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#96588a] text-white flex items-center justify-center flex-shrink-0 text-xs font-bold">2</div>
                      <p>Navigate to WooCommerce → Settings → Payments</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#96588a] text-white flex items-center justify-center flex-shrink-0 text-xs font-bold">3</div>
                      <p>Enable "Kang Open Banking" and paste your credentials</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#96588a] text-white flex items-center justify-center flex-shrink-0 text-xs font-bold">4</div>
                      <p>Configure payment methods and start accepting payments!</p>
                    </div>
                  </div>
                </motion.div>
                ...
                <div className="flex gap-4 pt-6">
                  <Button
                    ...
                    className="flex-1 bg-[#96588a] hover:bg-[#7a466f] text-white rounded-xl py-6 shadow-lg transition-all duration-200 hover:scale-[1.02]"
                  >
                  ...
                  <Button
                    ...
                    className="flex-1 border-2 border-[#96588a] text-[#96588a] hover:bg-[#96588a]/5 rounded-xl py-6 transition-all duration-200 hover:scale-[1.02]"
                  >
                    Manage Integration
                  </Button>
                </div>
      ...
      <div className="container relative z-10 max-w-6xl mx-auto py-16 px-4">
        ...
        >
          ...
          <h1 className="text-5xl font-bold mb-4 text-foreground">
            Register Your <span className="text-[#96588a]">WooCommerce Store</span>
          </h1>
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              <Card className="bg-white border border-border rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-6 text-center">
                  <feature.icon className="w-10 h-10 text-[#96588a] mx-auto mb-3" strokeWidth={1.5} />
        ...
        >
          <Card className="max-w-2xl mx-auto bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl border-2 border-[#96588a]/10">
            <CardHeader className="pb-6">
              <CardTitle className="flex items-center gap-2 text-2xl">
                <Store className="h-6 w-6 text-[#96588a]" />
                Store Details
              </CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="store_name" className="flex items-center gap-2 text-base font-semibold">
                    <Store className="h-4 w-4 text-[#96588a]" />
                    Store Name
                  </Label>
                  <Input
                    id="store_name"
                    ...
                    required
                    className="border-2 focus:border-[#96588a] rounded-xl"
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="store_url" className="flex items-center gap-2 text-base font-semibold">
                    <Globe className="h-4 w-4 text-[#96588a]" />
                    Store URL
                  </Label>
                  <Input
                    id="store_url"
                ...
                <div className="space-y-2">
                  <Label htmlFor="admin_email" className="flex items-center gap-2 text-base font-semibold">
                    <Mail className="h-4 w-4 text-[#96588a]" />
                    Admin Email
                  </Label>
                  <Input
                    id="admin_email"
                ...
                <Alert className="bg-[#96588a]/5 border-2 border-[#96588a]/20 rounded-xl">
                  <AlertDescription className="text-[#96588a]">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-[#96588a] hover:bg-[#7a466f] text-white rounded-xl py-6 text-lg shadow-lg transition-all duration-200 hover:scale-[1.02]" 
                  disabled={loading}
                >
              ...
              <div className="mt-6 pt-6 border-t text-center">
                ...
                <Button
                  variant="link"
                  className="text-[#96588a] hover:text-[#7a466f]"
                  asChild
                >
