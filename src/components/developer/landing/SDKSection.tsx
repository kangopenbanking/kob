...
const sdks = [
  { name: "Node.js / TypeScript", install: "npm install @kangopenbanking/sdk", badge: "v1.1.0", status: "available" },
  { name: "Python", install: "pip install kangopenbanking", badge: "v1.1.0", status: "available" },
  { name: "PHP / Laravel", install: "composer require kangopenbanking/sdk", badge: "v1.1.0", status: "available" },
