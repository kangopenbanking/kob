        ...
        <div className="flex flex-wrap gap-4 pt-2">
          <Link to="/developer/getting-started">
            <Button size="lg" className="text-base px-6">
              {t('developer.hero.cta.keys' as any)} <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </Link>
          <Link to="/developer/console">
            <Button size="lg" variant="outline" className="text-base px-6">
              <Play className="mr-2 h-4 w-4" /> {t('developer.hero.cta.console' as any)}
            </Button>
          </Link>
        </div>
        <p className="text-xs text-muted-foreground pt-2">
          {t('developer.hero.footer' as any)}
        </p>
      </div>
    </div>
  );
