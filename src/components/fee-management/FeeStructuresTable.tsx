...
const TX_TYPE_META: Record<string, { icon: any; category: string; label: string }> = {
  ...
  card_issuance_fee: { icon: CreditCard, category: "Cards", label: "Card Issuance Fee (one-off)" },
  card_maintenance_fee: { icon: CreditCard, category: "Cards", label: "Card Maintenance Fee (monthly)" },
  card_transaction_fee: { icon: CreditCard, category: "Cards", label: "Card Transaction Fee (per spend)" },
