...
import { DollarSign, Percent, Layers, Plus, Trash2, Globe, Building2, CheckCircle2, ArrowRight, ArrowLeft, Sparkles, Calculator, Search } from "lucide-react";
import { cn } from "@/lib/utils";

const TRANSACTION_TYPES = [
  { value: "transfer", label: "Account Transfer", icon: "💸", category: "Core" },
  { value: "payment", label: "Payment", icon: "💳", category: "Core" },
  { value: "bill_payment", label: "Bill Payment", icon: "🧾", category: "Core" },
  { value: "mobile_money_transfer", label: "Mobile Money Transfer", icon: "📱", category: "Mobile" },
  { value: "mobile_money_charge", label: "Mobile Money Charge", icon: "📲", category: "Mobile" },
  { value: "bank_transfer", label: "Bank Transfer", icon: "🏦", category: "Core" },
  { value: "card_payment", label: "Card Payment", icon: "💳", category: "Cards" },
  { value: "virtual_card_topup", label: "Virtual Card Top-up", icon: "🔄", category: "Cards" },
  { value: "qr_payment", label: "QR Payment", icon: "📷", category: "Core" },
  { value: "piggybank_deposit", label: "Piggy Bank Deposit", icon: "🐷", category: "Savings" },
  { value: "piggybank_withdrawal", label: "Piggy Bank Withdrawal", icon: "🐷", category: "Savings" },
  { value: "njangi_contribution", label: "Njangi Contribution", icon: "🤝", category: "Social" },
  { value: "njangi_payout", label: "Njangi Payout", icon: "🤝", category: "Social" },
  { value: "rent_payment", label: "Rent Payment", icon: "🏠", category: "Core" },
  { value: "loan_disbursement", label: "Loan Disbursement", icon: "📤", category: "Lending" },
  { value: "loan_repayment", label: "Loan Repayment", icon: "📥", category: "Lending" },
  { value: "savings_deposit", label: "Savings Deposit", icon: "💰", category: "Savings" },
  { value: "savings_withdrawal", label: "Savings Withdrawal", icon: "💰", category: "Savings" },
  { value: "international_transfer", label: "International Transfer", icon: "🌍", category: "International" },
  { value: "ussd_payment", label: "USSD Payment", icon: "📞", category: "Mobile" },
  { value: "withdrawal", label: "Cash Out", icon: "🏧", category: "Core" },
  { value: "account_funding", label: "Account Funding", icon: "➕", category: "Core" },
  { value: "gateway_charge", label: "Gateway Charge", icon: "⚡", category: "Gateway" },
  { value: "gateway_payout", label: "Gateway Payout", icon: "📤", category: "Gateway" },
  { value: "paypal_payment", label: "PayPal Payment", icon: "🌐", category: "International" },
  { value: "fx_conversion", label: "FX Conversion", icon: "💱", category: "International" },
  { value: "escrow_payment", label: "Escrow Payment", icon: "🔒", category: "Core" },
  { value: "api_request", label: "API Request", icon: "🔌", category: "Gateway" },
  { value: "mobile_recharge", label: "Mobile Recharge", icon: "📶", category: "Mobile" },
  { value: "invoice_create", label: "Invoice Create", icon: "📄", category: "Core" },
];
