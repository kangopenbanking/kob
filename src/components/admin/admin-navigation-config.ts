...
export const adminNavigation: AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "KYC Dashboard", path: "/admin/kyc-dashboard", icon: ShieldCheck },
      ...
      { title: "Nium Webhook Audit", path: "/admin/nium-webhook-audit", icon: Shield },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Audit Log Explorer", path: "/admin/audit-log-explorer", icon: ScrollText },
