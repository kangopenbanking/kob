...
Official Node.js / TypeScript SDK for the **Kang Open Banking (KOB) v1 API** (v1.7.0, aligned to OpenAPI v4.51.0).
...
- **1.2.0** — Aligned to OpenAPI v4.29.3. PISP `submitPayment` now requires
