...
const codeStyle = {
  fontFamily: "'Courier New', Courier, monospace", fontSize: '32px', fontWeight: 'bold' as const,
  color: '#0A3D91', letterSpacing: '6px', textAlign: 'center' as const, margin: '0 0 24px',
  padding: '16px 0', backgroundColor: '#F3F4F6', borderRadius: '12px',
}
