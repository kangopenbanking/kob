...
paths['/v1/directory/banks/cm'] = { get: { tags: ['Directory'], summary: 'List Cameroon banks with RIB structure and SWIFT codes', operationId: 'directoryBanksCm', security: [], responses: { '200': { description: 'Cameroon bank directory', content: { 'application/json': { schema: { type: 'object', properties: { country: { type: 'string' }, banks: { type: 'array', items: { type: 'object', properties: { bank_code: { type: 'string' }, bank_name: { type: 'string' }, swift_bic: { type: 'string' }, supports_rib: { type: 'boolean' } } } } } } } } } } } };
